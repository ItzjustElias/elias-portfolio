...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-black text-white font-sans selection:bg-[white/20] selection:text-white">
      <div className="fixed inset-0 z-0 opacity-20 pointer-events-none" 
           style={{ backgroundImage: 'radial-gradient(#ffffff 1px, transparent 1px)', backgroundSize: '40px 40px' }} />

      <div className="relative z-10 max-w-3xl mx-auto pt-32 pb-20 px-6">
        <Link href="/" className="font-mono text-[10px] uppercase tracking-[0.3em] text-zinc-500 hover:text-white/20 transition-colors mb-16 inline-block">
          ← Back_to_Index
        </Link>
